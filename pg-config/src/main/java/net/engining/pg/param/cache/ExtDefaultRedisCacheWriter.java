...
/**
 * 由于{@link org.springframework.data.redis.cache.DefaultRedisCacheWriter}不可见，无法被继承，所以在这里复制该类
 * @author luxue
 *
 */
public class ExtDefaultRedisCacheWriter implements RedisCacheWriter {
	 ...
	 */
	public ExtDefaultRedisCacheWriter(RedisConnectionFactory connectionFactory) {
	 ...
	 *          to disable locking.
	 */
	public ExtDefaultRedisCacheWriter(RedisConnectionFactory connectionFactory, Duration sleepTime) {
