...
public class XmlRedisCachedParameterFacility extends XmlGuavaCachedParameterFacility {
	
	private static final Logger logger = LoggerFactory.getLogger(XmlRedisCachedParameterFacility.class);
