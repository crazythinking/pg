...
public abstract class AbstractJUnit4SpringContextTestsWithServlet implements TestCase{
	
	private static final Logger log = LoggerFactory.getLogger(AbstractJUnit4SpringContextTestsWithServlet.class);
